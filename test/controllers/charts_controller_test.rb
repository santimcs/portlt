...
class ChartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chart" do
    assert_difference('Chart.count') do
      post charts_url, params: { chart: { image_q: @chart.image_q, image_y: @chart.image_y, name: @chart.name, quarter: @chart.quarter, ticker: @chart.ticker, year: @chart.year } }
    end
  ...
  test "should update chart" do
    patch chart_url(@chart), params: { chart: { image_q: @chart.image_q, image_y: @chart.image_y, name: @chart.name, quarter: @chart.quarter, ticker: @chart.ticker, year: @chart.year } }
